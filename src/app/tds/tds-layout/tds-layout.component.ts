...
export class TDSLayoutComponent implements OnInit {
  ...
  */
  ...
  constructor(
    ...
    this.Menu = [
      { id: 1, title: 'My Dashboard', url: '/tds/dashboard', type: 'no' },
      { id: 2, title: 'TDS Return Dashboard', url: '/tds/tds-return-dashboard', type: 'no' },
      { id: 3, title: 'TDS Return', url: '/tds/tds-return', type: 'no' },
...

      {
        ...
        submenu: [
          { id: 22, title: 'MY Syllabus', url: '/tds/my-syllabus', type: 'no' },
          { id: 23, title: 'Trainer For Batch', url: '/tds/masters/trainer', type: 'no' },
          { id: 24, title: 'Branch Manager For Branch', url: '/tds/masters/branch-manager', type: 'no' },
          { id: 25, title: 'Content Writer For Subject', url: '/tds/masters/content-writer', type: 'no' },
          { id: 26, title: 'Counsellor For Branch', url: '/tds/masters/counsellor', type: 'no' },
          { id: 27, title: 'Accountant For Branch', url: '/tds/masters/accountant', type: 'no' },
          { id: 28, title: 'Attendance Sheet', url: '/tds/masters/attendance', type: 'no' },
          { id: 29, title: 'Daily Work Sheet', url: '/tds/masters/daily-work', type: 'no' },
          { id: 30, title: 'All Birthdays', url: '/tds/masters/birthdays', type: 'no' },
        ]
      },
      ...
      {
        id: 47, title: 'Counselors Planing', url: '/tds/counsellor-planning', type: 'no',
        submenu: [
          { id: 48, title: 'Trainers Planing', url: '/tds/counsellor-planning/trainers-planing', type: 'no' },
          { id: 49, title: 'Batches Planing', url: '/tds/counsellor-planning/Batches-planing', type: 'no' },
        ]
      },
...

      {
        ...
        // submenu: [
        //   { id: 57, title: 'Add Business Leads', url: '/tds/business-lead/add-business-lead', type: 'no' },
        //   { id: 58, title: 'All Business Leads', url: '/tds/business-lead/all-business-lead', type: 'no' },
        // ]
      },
    ]
